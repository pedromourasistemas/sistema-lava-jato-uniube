...
?>		 
          ...
          <td><input style="width:160px;" type="text" name="nome" id="nome"  value="<? echo utf8_encode($Resultado['Nome']); ?>"></td>
          <td>
          	<input style="width:160px;" type="text" name="endereco" id="endereco"  value="<? echo utf8_encode($Resultado['Endereco']); ?>">					          </td>
          <td>
          	<input style="width:110px;" type="text" name="bairro" id="bairro" value="<? echo utf8_encode($Resultado['Bairro']); ?>">
          </td>
          <td>
