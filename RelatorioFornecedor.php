...
<HTML>
			...
			function salvaDados()
			{
				...
				$.ajax({
					...
					{	
						...
						{
							alert(Result[1]);
							chamaPagina('RelatorioFornecedor.php');
						}
						else
						{
							alert(Result[1]);
    ...
    <BODY>        
        <H1 id="tituloRelatorioPessoas">RELATÓRIO DE FORNECEDORES</H1>
        	...
        	<FORM action="excluirPessoa.php" method="get">               
                <table id="tableReportPessoa" align="center" style="margin-top:300px"  border="1">
                    <tbody>
						...
						echo '<div id="mostraPaginacaoFornecedor">';
						
						for($i = 1; $i <= $QtdPagina; $i++)
						{
							echo '<a onClick="paginacao(\'RelatorioFornecedor.php\', '.$i.')" style="cursor:pointer;"> '.$i.'</a>';
						}
						...
						while ($Registro = mysql_fetch_array($Resultado)) 
						{
						   ...
						   <tr class="<?= $class ?>" id="itemContainer_<?=$Registro['CPF']?>">		
                        	  <td><? echo $CPFMascarado ?></td>
							  <td><? echo utf8_decode($Registro['Nome']); ?></td>
							  <td><? echo utf8_decode($Registro['Endereco']); ?></td>
							  <td><? echo utf8_decode($Registro['Bairro']); ?></td>
                              <td><? echo $Registro['Numero']; ?></td>
                              <td><? echo $TelefoneMascarado ?></td>
                              <td><? echo $CelularMascarado ?></td>
                              ...
                              <td>
                              	<a onClick="editaPessoa('editarPessoaFornec.php', <?= $Registro['CPF']; ?>)" style="cursor:pointer;">
        ...
        <!--<DIV class="figuraReportCliente">
        	<img src="images/Icones64x64/IconeRelatorio2.png" alt="cadastro">
        </DIV>-->
        
        <div id="resultado" ></div>
        
        <DIV id="returnReportFornecedor">
        	<a href="MenuRelatorios.php"><input type="image" src="images/return4.png"></a>
            <a href="RelatorioPDFFornecedor.php" id="Printer"><input type="image" src="images/printer10.png"></a>
